...
path = '/home/chidanand/Experiments/re3-tensorflow-master/demo/data3'
image_paths = sorted(glob.glob(os.path.join(os.path.dirname(__file__), 'data3', '*.jpg')))
image_paths = [(path + "/" + "baid_" + str(i) + ".jpg") for i in range(0, len(image_paths)-2)]
initial_bbox = [137,41,144,59]
